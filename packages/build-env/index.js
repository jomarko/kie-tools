...
const ENV_VARS = {
  ...
  ONLINE_EDITOR__kieToolingExtendedServicesDownloadUrlLinux: {
    ...
    default: `https://github.com/kiegroup/kogito-tooling-go/releases/download/${version}/kie_tooling_extended_services_linux_${version}.tar.gz`,
    description: "",
  },
  ...
  ONLINE_EDITOR__kieToolingExtendedServicesDownloadUrlWindows: {
    ...
    default: `https://github.com/kiegroup/kogito-tooling-go/releases/download/${version}/kie_tooling_extended_services_windows_${version}.exe`,
    description: "",
  },
